...
**Responsibilities**<br>
- Collected multimodal data, including neural (EEG), salivary, and behavioral markers of aging, along with neuropsychological assessments, from a socioeconomically and ethnically diverse Malaysian cohort.
 
- Conducted EEG data acquisition, preprocessing, and computed event-related potentials using MATLAB to identify neurophysiological markers associated with aging.
...
- Managed participant recruitment and engagement, ensuring a diverse sample of single adults, and coordinated data collection during the COVID-19 pandemic.
 
- Cleaned and preprocessed survey data to ensure data quality and integrity, including handling missing data, outliers, and validating responses for consistency.
...
[Poster Available](http://dx.doi.org/10.13140/RG.2.2.12484.85121).
